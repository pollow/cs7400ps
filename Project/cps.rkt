...
(define-metafunction ST
  ...
  [(cps (s.e_1 \; s.e_2) ((s.x_1 s.t_1) ...) (t.α_2 ...) (t.x_2 ...))
   ...
   (where t.x_1 ,(variable-not-in (term (t.e_2 s.x_1 ... t.x_2 ...)) (term x)))
...
#;(term (cps (λ (f (int -> int)) (λ (g (int -> int)) ((f 0) \; ((g 0) \; 0)))) () () ()))
...
#;(λ (α)
   ...
   (k
    (λ (α1)
      (f1 (∀ (α) int -> ((int -> α) -> α)))
      (λ (k2 ((∀ (α) (∀ (α) int -> ((int -> α) -> α)) -> ((int -> α) -> α)) -> α1))
        (k2
            (λ (α2)
              (g1 (∀ (α) int -> ((int -> α) -> α)))
              (λ (α)
                   (k (int -> α))
                   ((f1 (α) 0) (α) (λ (x int) ((g1 (α) 0) (α) (λ (x int) (k 0))))))))))))
