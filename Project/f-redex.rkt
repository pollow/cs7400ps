...
(define red
  (reduction-relation
   ...
   (--> (in-hole E ((λ [α] (x t_1) e) [t] v))
        (in-hole E (subst-x x v (subst-λα α t e)))
        "βαv")
...
(define-metafunction F
  subst-λα : α any any -> any
  ;; 1. α_1 bound, so don't continue in λ body
  [(subst-λα α_1 any_1 (λ [α_1] (x_1 t_1) any_2))
   (λ [α_1] (x_1 t_1) any_2)]
  [(subst-λα α_1 any_1 (∀ [α_1] any_2))
   (∀ [α_1] any_2)]
  ;; 2. general purpose capture avoiding case
  [(subst-λα α_1 any_1 (λ [α_2] (x_1 t_1) any_2))
   (λ [α_new] (x_1 t_1)
      (subst-λα α_1 any_1
  ...
  [(subst-λα α_1 any_1 (∀ [α_2] any_2))
   ...
   (where α_new ,(variable-not-in
                  (term (α_1 any_1 any_2)) 
                  (term α_2)))]
  [(subst-λα α_1 any_1 α_1) any_1]
  [(subst-λα α_1 any_1 α_2) α_2]
  [(subst-λα α_1 any_1 (any_2 ...))
   ((subst-λα α_1 any_1 any_2) ...)]
  [(subst-λα α_1 any_1 any_2) any_2])
